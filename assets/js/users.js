...

{
...

    {
...

        {
            ...
            url: ajax_url + "users/fetch_users",
...

    {
...

        {
            ...
            $.ajax(ajax_url + 'users/reset_user_password',
...

            {
...

                {
...

                    {
                        ...
                        $.post(ajax_url + 'users/activate_account',
