 ...
 *
 */
$config['APIUsername'] = $config['Sandbox'] ? 'keentesting77-facilitator_api1.gmail.com' : 'manpreets.vismaad-facilitator_api1.gmail.com';
$config['APIPassword'] = $config['Sandbox'] ? 'N9QLEGQWVJ4WAFAT' : '4VTF4U853TXRVDSR';
$config['APISignature'] = $config['Sandbox'] ? 'AOYJVCgMkBJR7EqSlv-PcHK6.-umAbVEOZhMRqrSByo4c0PU.GCMKJMk' : 'AFcWxV21C7fd0v3bYYYRCpSSRl31A-M8vhwvGxrsgTikyS14Ar1QZKR7';
