...

{
...

    {
        ...
        if ($this->CI->db->where("User_Email = '$User_Email'")->get('users')->num_rows() > 0)

        {

            if ($this->CI->db->where("( User_Email = '$User_Email') AND Is_Deleted='0'")->get('users')->num_rows() > 0)
...

    {
        ...
        $this->CI->form_validation->set_message('is_unique_update','This %s has been already used.');
