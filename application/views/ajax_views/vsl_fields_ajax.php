...
<?php }else if($value['Template_Field_Type'] == 'textarea'){ ?>
    ...
    <div class="col-lg-12 col-md-12 col-sm-6 col-xs-12">
        <div class="form-group form-grp">
            <label class="control-label"><?php echo $value['Template_Field_Title']; ?> <span>*</span></label>
                <textarea name="Temp_Field[<?php echo $value['Template_Field_Id']; ?>]" id="texn_<?php echo $value['Template_Field_Id']; ?>" class="form-control required textarea_field_<?php echo $value['Template_Field_Id']; ?>" placeholder="<?php echo $value['Template_Field_Placeholder']; ?>"><?php echo isset($value['Field_Data_Value'])? html_entity_decode($value['Field_Data_Value']):''; ?></textarea>
        </div> 
    </div>
     ...
     <script type="text/javascript">
        ...
        /*initilize datetimepicekr on VLS ajax*/
          $('.timer-class').datetimepicker({
               format: 'hh:mm:ss'
          });
...
<?php }else if($value['Template_Field_Type'] == 'Time'){ ?>

    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <div class="form-group form-grp">
            <label class="control-label"><?php echo $value['Template_Field_Title']; ?></label>
                <input type="text" name="Temp_Field[<?php echo $value['Template_Field_Id']; ?>]" id="<?php echo $value['Template_Field_Key']; ?>" class="form-control timer-class" placeholder="<?php echo $value['Template_Field_Placeholder']; ?>" value="<?php echo isset($value['Field_Data_Value'])? $value['Field_Data_Value']:''; ?>">
        </div> 
    </div>
