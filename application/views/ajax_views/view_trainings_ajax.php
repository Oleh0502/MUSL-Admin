                                ...
                                <div class="mt-element-list">
                                    <div class="mt-list-head list-news font-white bg-blue" style="">
                                        <div class="list-head-title-container">
                                            ...
                                            <h4 class="list-title text-left text-captalize"><?php echo $value['Video_Title']; ?></h4>
                                        </div>
                                    </div>
...
if(count($videos) < DEFAULT_NO_PER_PAGE){
    ...
    <button type="submit" class="btn btn-primary mt-ladda-btn ladda-button" data-style="expand-left" data-spinner-color="#333" id="load_more_btn" onclick="load_more('.($page+1).','.($training_type).');"> <span class="ladda-label"> Load More</span> </button>
</div>';
}
