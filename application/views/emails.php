                			...
                			<div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group fix-form-group form-grp">
                                        ...
                                        <input type="text" class="form-control digits" name="Add_Days" id="Add_Days" placeholder="days">
                                	</div> 
                                </div>
                            </div>
                            <div class="row">
                    	...
                    	<form id="edit_email_form">
                			...
                			<div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group fix-form-group form-grp">
                                        <label class="control-label">Days<span>*</span></label>
                                        <input type="number" class="form-control digits" name="Edit_Days" id="Edit_Days" placeholder="Days">
                                	</div> 
                                </div>
                            </div>
                            <div class="row">
